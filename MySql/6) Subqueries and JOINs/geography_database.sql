...
/*!40000 ALTER TABLE `countries`
    DISABLE KEYS */;
INSERT INTO `countries` (`country_code`, `iso_code`, `country_name`, `currency_code`, `continent_code`, `population`,
                         `are_in_sq_km`, `capital`)
VALUES ('AD', 'AND', 'Andorra', 'EUR', 'EU', 84000, 468, 'Andorra la Vella'),
...
/*!40000 ALTER TABLE `countries_rivers`
    DISABLE KEYS */;
INSERT INTO `countries_rivers` (`river_id`, `country_code`)
VALUES (1, 'BI'),
       (1, 'CD'),
       (1, 'EG'),
       (1, 'ER'),
